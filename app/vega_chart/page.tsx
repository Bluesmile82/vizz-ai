...
export default function AgentsPage() {
  const InfoCard = (
    <div className="p-4 md:p-8 rounded bg-[#25252d] w-full max-h-[85%] overflow-hidden">
      <h1 className="text-3xl md:text-4xl mb-4">
        ▲ Next.js + LangChain.js Vega Chart 🦜🔗
      </h1>
      <ul>
        <li className="text-l">
          <span className="ml-2">
            This template showcases how to output Vega charts through json files with a{" "}
        ...
        <li className="hidden text-l md:block">
          ...
          <span className="ml-2">
            ...
            <code>app/vega_chart/page.tsx</code>.
          </span>
        </li>
        <li className="text-l">
          👇
          <span className="ml-2">
            Try typing e.g. <code>
              red is 100 blue is 500</code> below!
          </span>
        </li>
      </ul>
    </div>
  ...
  return (
    <ChatWindow
      endpoint="api/chat/vega_chart"
      emptyStateComponent={InfoCard}
      placeholder={`Ask for a visualization!`}
      emoji="🌳"
      titleText="Vega chart"
    ></ChatWindow>
  );
}
